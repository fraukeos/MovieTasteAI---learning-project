...
### Vollständiger Modus
Mit eigenem TMDb API Key.
Dabei werden aktuelle Filmdaten direkt von TMDb geladen.
...
├── data_demo/                  
│   ├── netflix_history.csv     (Netflix-Historie, muss manuell eingefügt werden, Beispiel vorhanden)
│   ├── movies.csv              (Beispieldaten für Demo-Modus)
│   └── candidates.csv          (Beispieldaten für Demo-Modus)
│
...
|
├── output_example/             (Ordner mit Beispielergebnissen)
│   ├── recommendations_example.csv
│   ├── recommendations_example.png
│   ├── feature_importance_example.csv
│   └── feature_importance_example.png
|
├── main.py
├── tmdb.py
├── MODEL.md
...
data_demo        |  Eingabedaten und Beispiel-Filmdaten für Demo-Modus
output_example/	 |  Ordner mit Beispielen für Ergebnis-CSV und Visualisierungen
